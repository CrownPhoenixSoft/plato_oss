...
export default function CTA() {
  return (
    <MaxWidthWrapper className="flex flex-col items-center justify-center space-y-5 pt-20 text-center">
      ...
      <h2 className="font-display bg-gradient-to-r from-primary to-secondary-foreground bg-clip-text text-4xl font-extrabold leading-tight text-transparent sm:text-5xl sm:leading-tight">
        <span className="">Supercharge</span>
        <br />
